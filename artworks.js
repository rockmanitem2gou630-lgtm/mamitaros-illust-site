const artworks = [
  ...
  gameCharacterImages: [
    ...
    {
      src: "images/originals/2026/09/20260903_deno_game_ura.webp",
      alt: "ウラタロス キャラクター紹介"
    },
    {
      src: "images/originals/2026/09/20260903_deno_game_kin.webp",
      alt: "キンタロス キャラクター紹介"
    },
    {
  ...
  gameHistory: [
    {
      date: "2026.09.08",
      items: [
        "モモタロス、ウラタロスの後日談、スチル追加。",
        "それに伴いＵＩの変更とストーリーシステムの拡張を行いました。"
      ]
    },
    {
      date: "2026.09.04",
      items: [
        "スチルのギャラリー、進行度の自動保存、リセット機能を追加。",
        "※ブラウザで保存されるので永久保存はされません。"
      ]
    },
    {
      date: "2026.09.03",
      items: [
        "「準備中」だったストーリー機能を追加しました。",
        "モモタロス、ウラタロス、キンタロス、リュウタロスの各ルートを実装。"
      ]
    },
    {
      date: "2026.08.07",
      items: ["バックログ、オート、UIを隠す機能追加。"]
    },
    {
      date: "2026.08.03",
      items: [
        "憑依中、内側から良太郎が発言しても違和感ない会話を抽選枠に入れるように調整。",
        "それに伴う演出処理の強化。"
      ]
    },
    {
      date: "2026.07.31",
      items: [
        "細かい調整、演出の強化、会話の追加。とりあえずの完成。",
        "「準備中」のボタンはおまけなのでゆっくり準備します。"
      ]
    },
    { date: "2026.07.30", items: ["リュウタロス実装。", "ランダム憑依実装。オンオフ切り替え可。"] },
    { date: "2026.07.25", items: ["キンタロス実装。", "憑依横取りの横取りに対応しました。"] },
    { date: "2026.07.21", items: ["ウラタロス実装。", "イマジン同士で憑依の横取りをするようになりました。"] },
    { date: "2026.07.20", items: ["公開しました。"] }
  ],

  tags: ["電王", "ゲーム"],
  comment: "ほぼ乙女ゲー。　製作期間7月～……9月現在制作中。",
  dream: true,
  draft: false
},
];